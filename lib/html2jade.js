      ...
      if (!attrs || attrs.length === 0) {
        ...
        for (_i = 0, _len = attrs.length; _i < _len; _i++) {
          ...
          if (attr && attr.nodeName) {
            ...
            if (attrName === 'placeholder' && isValidJadeId(attrValue)) {
            } else if (attrName === 'type' && isValidJadeId(attrValue)) {
              if(attrValue === 'text') attrValue='input';
              result.push(this.buildTagAttr('data-type', attrValue));
            } else if (attrName === 'id' && isValidJadeId(attrValue)) {
              result.push(this.buildTagAttr('data-key', attrValue));
